...
const PosterPrimary = ({ maxWidth = '185px', src, path, alt }) => {
  return (
    <div style={{ maxWidth }}>
      <div className="overflow-hidden bg-blue-100 rounded-md shadow-xl aspect-w-2 aspect-h-3">
        <Image
          src={
            path
              ? src
